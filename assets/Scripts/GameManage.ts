...
import { _decorator, Component, Node, MeshRenderer, color, Color, Toggle, RigidBody, director, Vec3, SliderComponent, Slider, ProgressBar, game, randomRange, input, Input, EventKeyboard, KeyCode } from 'cc';
...
export class GameManager extends Component {
    ...
    onKeyDown(event: EventKeyboard) {                           ////For Testing Purpose Only

        switch (event.keyCode) {
            case KeyCode.SPACE:
                if (this.ballGameObject.active == false) {
